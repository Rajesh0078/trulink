...
const Login = () => {
  const [acitveTab, setActiveTab] = useState('email');
    ...
    <div className='w-full h-full flex z-100'>
      <div className='h-full w-1/2 bg-surface border-r border-border hidden lg:flex-between py-22 flex-col px-[5%]'>
        ...
        <div>
          <div className='w-full mt-10 text-text-2'>
            TruLink is a next-generation social discovery platform where anonymity meets authenticity. Browse real people from across the globe — no judgements, no filters on who you are. Whether you&apos;re looking for a late-night philosophical debate, a fellow gamer to team up with, or just someone to share your day with, TruLink&apos;s intelligent matching engine surfaces the right stranger at the right moment.
          </div>
          <div className='flex gap-4 mt-5'>
            <div className='card p-6!'>
              ...
              <div className='text-text-2 text-xs mt-2'>No signup needed. Jump in instantly with zero personal info required. Your identity, your choice.</div>
            </div>
            <div className='card p-6!'>
              ...
              <div className='text-text-2 text-xs mt-2'>Upgrade to a permanent account for chat history, friend lists, custom profiles, and exclusive features.</div>
            </div>
          </div>
        </div>
      </div>
      <div className='h-full w-full lg:w-1/2 flex pt-21 flex-col px-[8%]'>
        ...
        <div className='flex gap-2 sm:gap-4 w-full mt-0'>
          ...
          <button
            className='btn-outlined sm:text-[16px] gap-2 sm:h-10! text-gray-400 w-full'
          >
        ...
        <div className='mt-4 flex flex-col items-center gap-1 text-center'>
          ...
          <p className='text-[13px] text-text-3 mt-2'>
            © 2026 TruLink. All rights reserved.
          </p>
        </div>
      </div>
    </div>
